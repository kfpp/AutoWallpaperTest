...
public class FileBrowserUtils {
    ...
    public FileBrowserUtils(Activity context) {
        mActivity = context;
    }

    public void showFileBorwser() {
    ...
    public boolean isResult(int requestCode) {
        return requestCode == REQUEST_CODE;
    }


    public String onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        String path = null;
